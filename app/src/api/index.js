...
//对外暴露一个函数，只要外部调用这个函数，就想服务器发起ajax请求，获取三级菜单的数据。当前的这个函数只需要把服务器返回结果返回即可
...
// 地址接口：/api/cart/addToCart/{ skuId }/{ skuNum }  请求方式：POST 参数个数：skuID，skuNum
...
//注册用户
//接口：URL  /api/user/passport/register  method：post 参数：phone code password,
...
//获取订单支付状态
//URL :/api/payment/weixin/queryPayStatus/{orderId}  method: get 参数：orderId
