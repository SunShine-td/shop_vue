        ...
        <div class="InfoWrap">
          ...
          <div class="choose">
            ...
            <div class="cartWrap">
              ...
              <div class="add">
                <!-- 以前咱们的鲁班跳转：从A路由跳转到B路由，这里加入购物车，在进行路由跳转之前，发请求，把你购买的产品信息通过请求的形式
                通知服务器，服务器进行相应的存储
                 -->
...
<script>
  ...
  export default {
    ...
    computed:{
      ...
      skuImageList(){
        // 给子组件的数据，如果服务器数据还没有回来，skuInfo这个对象是空对象
    ...
    methods: {
     ...
     async addShopcart(){
        ...
        /*
          当前这里是派发了一个action，也向服务器发请求，判断服务器成功了还是失败了进行相应的操作
          ...
          你需要知道这次请求成功还是失败。如果成功进行路由跳转，如果失败，需要给用户提示
        */
       try{
          //成功
        await this.$store.dispatch("addOrUpdateShopCart",{
          ...
          //路由跳转
          //一些简单的数据skuNum，通过query的形式给路由组件传过去
