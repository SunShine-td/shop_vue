...
​	3.2 点击提交订单的按钮的时候，还需要向服务器发起一次请求【把支付一些信息传递给服务器】

​	3.3 今天开始不在使用vuex而是其他的方法发请求获取数据

​	3.4不要在生命周期函数里面使用async
...
第二种：按需引入【按照开发需求引入相应的组件，并非全部组件引入】【修改配置文件需要重新启动项目】
